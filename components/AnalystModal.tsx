...
import { User, Check, X, ChevronRight, Phone, MessageSquare } from 'lucide-react';
            ...
            <div className="grid gap-4">
              {analysts.map((analyst, index) => (
                <button
                  ...
                  className="flex items-center gap-4 bg-white/5 hover:bg-white/10 border border-white/10 p-5 rounded-2xl transition-all duration-300 group w-full text-left active:scale-[0.98]"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-500 font-bold tracking-widest uppercase mt-1">Water Analyst</div>
                  </div>
                  <div className="bg-white/5 p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
